...
帕西尼感知 (PaXini) 专注于多维触觉技术，其传感器产品广泛应用于工业和消费领域。

### **PX-6AX Gen3 (工业级触觉传感器)**
- **定位**: 高端科研与工业应用。
- **核心能力**:
    - **15维感知**: 除了传统的 6维力 (3力+3力矩)，还能感知纹理、材质、温度等。
    - **极致精度**: 最小分辨率 **0.01N**，采样率 **1000Hz**。
    - **可靠性**: IP68 防护，寿命 >1000万次，适合恶劣工业环境。

### **PX-3AX (消费级触觉传感器)**
- **定位**: 大规模商业落地 (如扫地机、服务机器人)。
- **核心优势**:
    - **极致性价比**: 价格仅约 **~200 RMB**，打破了触觉传感器昂贵的刻板印象。
    - **易集成**: 专为低成本、大批量的消费电子产品设计。

> **Note**: 帕西尼也基于其触觉技术开发了灵巧手和人形机器人，详情请见：
> - 灵巧手: [DexH13](../product/hands.md#parsen-dexh13)
> - 人形机器人: [TORA-ONE](../product/humanoids.md#parsen-tora-one)
