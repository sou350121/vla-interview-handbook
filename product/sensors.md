...
| 特性 (Feature) | **ITPU / 霍尔阵列** (如 PaXini) | **光学视触觉** (如 GelSight, Daimon) | **压阻/电容阵列** (传统电子皮肤) | **传统六维力** (应变片式) |
| :--- | :--- | :--- | :--- | :--- |
| **核心原理** | **磁-电转换** (6D Hall Array) | **光-电转换** (Camera + Gel) | **接触电阻/电容变化** | **金属应变片形变** |
| **触点类型** | **多点面阵式** (Multi-point) | **连续曲面** (Continuous) | 多点阵列 | **单点式** (Single Point) |
| **结构形态** | **柔性表面** (Flexible) | 弹性体 + 刚性相机模组 | 薄膜 / 刚性 | 刚性 (Rigid) |
| **感知维度** | **6维力 + 纹理/材质** (15维+) | **3D 拓扑** + 剪切力 (间接) | 主测法向力 (Normal Force) | 仅 6维力 (Fx,Fy,Fz,Mx,My,Mz) |
| **空间分辨率** | **高** (0.1mm 级) | **极高** (微米级, Micron-level) | 中/低 | **无** (不具备空间分辨能力) |
| **响应速度** | **高** (~1000Hz) | **低** (30-120Hz, 受限于相机) | 高 | 高 (~1000Hz) |
| **迟滞 (Hysteresis)** | **低** | **高** (凝胶回弹慢) | 高 (压阻) / 低 (电容) | 极低 |
| **抗干扰能力** | **优** (软硬磁屏蔽优化) | **中** (受环境光/污渍影响) | 弱 (易受电磁干扰) | 优 |
| **耐久度 & 寿命** | **高** (>1000万次, 磁耦合无接触磨损) | **低** (凝胶易磨损/划伤, 需定期更换) | 中 (材料易疲劳/漂移) | **极高** (金属弹性体, 工业级寿命) |
| **集成度 & 尺寸** | **高** (SoC内置, 体积小) | **低** (需光路空间, 体积大/厚) | 低 (需外部采集卡) | 中 (通常较大) |
| **计算负载** | **低** (直接输出数字信号) | **极高** (需实时图像处理) | 中 | 低 |
| **典型成本** | **低/中** (百元/千元级) | **高** (相机+算力成本) | 高 (系统集成成本高) | **极高** (万元级) |
| **适用场景** | **灵巧手皮肤, 全身覆盖** | 精密检测, 实验室环境 | 简单接触检测 | 工业臂末端力控 |
