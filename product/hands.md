...
## 📐 统一条目模板（便于扩展）
- **型号 | 厂商 | 年份**
- **形态/定位**：3指/4指/5指 | 触觉/低成本/工业/教研
- **核心规格**：DOF | 驱动方式（伺服/气动/直驱）| 抓力 | 自重 | 行程/开口 | IP 等级
- **传感**：触觉/六维力/视觉在手、指尖传感点数/分辨率
- **接口与总线**：EtherCAT/CAN/RS485/Ethernet，I/O，供电 (24/48V)
- **法兰与兼容性**：安装法兰/尺寸、兼容的机械臂/快换
- **软件栈**：SDK/ROS 2/MoveIt 支持，固件升级注意
- **安全**：力限、软碰撞、机械限位
- **典型搭配**：推荐臂/传感器/算力/快换
- **维护与备件**：指套/线缆/减速器/凝胶等易耗，保养周期
- **Last Update**：YYYY-MM-DD

## 📊 速查表骨架
| 型号 | DOF | 驱动 | 抓力 | 自重 | 触觉/传感 | 接口/总线 | 法兰/安装 | 兼容臂 | 备注 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| TODO |  |  |  |  |  |  |  |  |  |
