...
### 0.2.1 淘宝 GELLO 整机代工 (推荐)

淘宝上有商家提供 **GELLO 整机代工服务**，省去自己采购零件和组装的麻烦：

| 方案 | 参考价格 | 包含内容 | 适合人群 |
|:---|:---|:---|:---|
| **整机代工** | ¥4000-6000 | 全套零件 + 组装 + 测试 | 时间宝贵、不想折腾 |
| **散件套装** | ¥3000-4000 | 全套零件 (需自行组装) | 动手能力强 |
| **仅 3D 打印件** | ¥200-500 | 打印好的结构件 | 已有电机和适配器 |
...
**选购建议**:
1. **确认适配机型**: 购买前确认是 UR5 版本 (不同机械臂的 GELLO 结构不同)
2. **确认电机型号**: 正品 Dynamixel (ROBOTIS) vs 国产仿制
3. **索要测试视频**: 要求商家提供组装后的运动测试视频
4. **售后支持**: 确认是否提供软件配置指导

> 💡 **经验**: 整机代工虽然贵几百块，但省去大量组装调试时间，对于赶进度的项目非常值得。
